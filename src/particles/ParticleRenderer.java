...
public class ParticleRenderer {
	...
	protected void render(Map<ParticleTextures, List<Particle>> particles, Camera camera){
		Matrix4f viewMatrix = Maths.createViewMatrix(camera);
		prepare();
		for(ParticleTextures texture : particles.keySet()){
			bindTexture(texture);
			...
			GL31.glDrawArraysInstanced(vbo, 0, quad.getVertexCount(), particleList.size());
		}
		finishRendering();
	}
	...
	private void bindTexture(ParticleTextures texture){
		if(texture.isAdditive() == true){
